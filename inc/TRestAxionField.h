...
class TRestAxionField : public TObject {
   ...
   public:
    ...
    Double_t GammaTransmissionFWHM(Double_t m_a = 0, Double_t Ea = 4, Double_t Bmag = 2.5,
                                   Double_t Lcoh = 10000, Double_t mg = 0, Double_t step = 0.00001,
                                   int n = 10000);

    std::pair<std::vector<Double_t>, std::vector<Double_t>> GetMassDensityScanning(std::string gasName = "He",
                                                                                   Double_t ma_max = 1,
                                                                                   Double_t Ea = 4.2);
