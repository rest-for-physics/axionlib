...
#ifndef _TRestAxionDiffSolarSpectrum
#define _TRestAxionDiffSolarSpectrum
...
class TRestAxionDiffSolarSpectrum : public TRestMetadata {
private:
    void Initialize();
...
public:
    TRestAxionDiffSolarSpectrum();
    TRestAxionDiffSolarSpectrum(const char *cfgFileName, std::string name = "");
    ~TRestAxionDiffSolarSpectrum();
    ...
    ClassDef(TRestAxionDiffSolarSpectrum, 1);
};
