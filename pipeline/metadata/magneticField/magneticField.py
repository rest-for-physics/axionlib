...
b5 = int(1000.0 * babyField.GetTransversalFieldAverage(startFrom, goTo, 20, 500))
...
boundaries = castField.GetFieldBoundaries(
    ROOT.TVector3(12, 34, 0), ROOT.TVector3(0, -1, 0)
)
