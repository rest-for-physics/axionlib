...
parser.add_argument('--out', dest='outfname', type=str, help='The output filename in png,pdf,C or any other ROOT accepted format')
parser.add_argument('--fluxname', dest='fluxname', type=str, help='The name of the flux definition to be chosen from the RML')
parser.add_argument('--N', dest='samples', type=int, help='The number of generated particles')
...
validation = False
if rmlfile == "fluxes.rml" and fluxname == "combined" and outfname == "flux.png" and samples == 20000:
    validation = True
