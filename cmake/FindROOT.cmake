...
#   include directory (deprecated) ROOT_INCLUDE_DIRS   PATH to the include
#   directory ROOT_LIBRARIES      Most common libraries ROOT_LIBRARY_DIR    PATH
#   to the library directory ROOT_BIN_DIR          PATH to the excutables
#   directory ROOT_PYTHONVER      Compatible python version string
...
if (NOT ROOT_CONFIG_EXECUTABLE)
    ...
    # set(ROOT_LIBRARIES ${ROOT_LIBRARIES} -lThread -lMinuit -lHtml -lVMC -lEG
    # -lGeom -lTreePlayer -lXMLIO -lProof) set(ROOT_LIBRARIES ${ROOT_LIBRARIES}
    # -lProofPlayer -lMLP -lSpectrum -lEve -lRGL -lGed -lXMLParser -lPhysics)
...
function (ROOT_GENERATE_DICTIONARY dictionary)
    ...
    # Filter out UNIX system directory to workaround bug in rootcint (info from
    # Andrea Dotti, and info from post:
    ...
    add_custom_command(
        ...
        COMMAND ${ROOTCINT_EXECUTABLE} -cint -f ${dictionary}.cxx -c
...
function (REFLEX_GENERATE_DICTIONARY dictionary)
    ...
    # set(rootmapname ${dictionary}Dict.rootmap) set(rootmapopts
    # --rootmap=${rootmapname} --rootmap-lib=${libprefix}${dictionary}Dict)
    ...
    add_custom_command(
        ...
        COMMAND
            ${GENREFLEX_EXECUTABLE} ${headerfiles} -o ${gensrcdict}
            ${gccxmlopts} ${rootmapopts} --select=${selectionfile}
            --gccxmlpath=${gccxmlpath} ${ARG_OPTIONS} ${includedirs}
            ${definitions}
