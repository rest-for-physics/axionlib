# * Try to find Garfield++ instalation This module sets up Garfield information
#   It defines: Garfield_FOUND          If Garfiled++ is found
...
# Alternative paths which can be defined by user set(Garfield_DIR "" CACHE PATH
# "Directory where Garfield is installed") set(Garfield_INC_DIR "" CACHE PATH
# "Alternative directory for Garfield includes") set(Garfield_LIB_DIR "" CACHE
# PATH "Alternative directory for Garfield libraries")
...
find_path(Garfield_INCLUDE_DIRS Sensor.hh
          HINTS ${Garfield_DIR}/include/ ${Garfield_DIR}/include/Garfield
                ${Garfield_INC_DIR} ${Garfield_DIR}/Include)
...
find_library(
    ...
    HINTS ${Garfield_DIR}/lib ${Garfield_LIB_DIR} $ENV{GARFIELD_HOME}/lib)
# message(STATUS Garfield_LIBRARIES ${Garfield_LIBRARIES})

# if (${Garfield_LIBRARY_DIR}) set (Garfield_LIBRARIES -L${Garfield_LIBRARY_DIR}
# -lGarfield) endif()
