...
void TRestAxionOptics::PrintMetadata() {
    ...
    RESTMetadata << "Optics center: (" << fCenter.X() << ", " << fCenter.Y() << ", " << fCenter.Z() << ") mm"
             << RESTendl;
    RESTMetadata << "Optics exit: (" << fExit.X() << ", " << fExit.Y() << ", " << fExit.Z() << ") mm" << RESTendl;
    RESTMetadata << "Optics axis: (" << fAxis.X() << ", " << fAxis.Y() << ", " << fAxis.Z() << ")" << RESTendl;
    ...
    if (fSpiderArmsSeparationAngle != 0) {
        ...
        RESTMetadata << " - Arms separation angle : " << 180. * fSpiderArmsSeparationAngle / TMath::Pi()
                 << " degrees" << RESTendl;
        RESTMetadata << " - First arm offset angle : " << 180. * fSpiderOffsetAngle / TMath::Pi() << " degrees"
                 << RESTendl;
        RESTMetadata << " - Arm angular width : " << 180. * fSpiderWidth / TMath::Pi() << " degrees" << RESTendl;
