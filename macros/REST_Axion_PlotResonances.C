...
//*******************************************************************************************************
//*** Description: This script plots the transmission probability as a function of the axion mass for a given gas and an
...
//***
//*** --------------
//*** Usage: restManager PlotResonances [ma_max=0.1] [ma_min=0] [Ea=4.2] [Bmag=2.5] [Lcoh=10000] [gasName=He] [vacuum=true] [n_ma=7000]
//***
...
int REST_Axion_PlotResonances(double ma_max =0.1, double ma_min=0, double Ea = 4.2, double Bmag=2.5, double Lcoh=10000 ,std::string gasName = "He", Bool_t vacuum = true, int n_ma = 10000){
