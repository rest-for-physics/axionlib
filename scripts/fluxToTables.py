...
parser.add_argument(
    ...
    dest="binsize",
    type=float,
    help="The energy bin size used at the .flux file [in eV].",
)
parser.add_argument(
    "--skiprows",
    dest="skiprows",
    type=int,
    help="The number of header rows to be skipped",
)
...
fluxTable = TH2D("flux", "Flux table", 100, 0.0, 1.0, 200, 0.0, 20.0)
